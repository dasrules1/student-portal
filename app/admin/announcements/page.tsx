...
export default function AdminAnnouncements() {
  ...
  const [newAnnouncement, setNewAnnouncement] = useState({
    title: "",
    message: "",
    classId: "all", // "all" means all classes
  })
  ...
  const handleCreateAnnouncement = async () => {
    ...
    try {
      const user = sessionManager.getCurrentUser()
      const userId = user?.user?.uid || user?.user?.id
      const userName = user?.user?.name || user?.user?.displayName || "Admin"

      if (newAnnouncement.classId === "all") {
        // Create announcement for all classes
        const allClasses = await storage.getClasses()
      ...
      setNewAnnouncement({ title: "", message: "", classId: "all" })
    ...
    <div className="container mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Create and manage announcements for any class or all classes</p>
        </div>
                  ...
                  <div className="flex-1">
                    ...
                    <CardDescription className="mt-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        <Badge variant="outline">{announcement.className || "All Classes"}</Badge>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Share important information with students</DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
