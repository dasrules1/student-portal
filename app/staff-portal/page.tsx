...
export default function StaffPortal() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Check if the user has the selected role or is trying to access the correct portal
    if (
      (formData.role === "admin" && user.role === "admin") ||
      (formData.role === "teacher" && user.role === "teacher")
    ) {
      // Set user in session
      ...
      toast({
        title: "Access denied",
        description: `You don't have ${formData.role} privileges`,
        variant: "destructive",
      })
    }
