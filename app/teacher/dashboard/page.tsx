                        ...
                        <div className="grid grid-cols-2 text-sm gap-y-1">
                          ...
                          {cls.teacherJoinLink && (
                            <>
                              ...
                              <a href={cls.teacherJoinLink?.startsWith('http') ? cls.teacherJoinLink : `https://${cls.teacherJoinLink}`} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline break-all">
                                Join Class
                              </a>
                            </>
                          )}
                          ...
                          {cls.studentJoinLink && (
                            <>
                              ...
                              <a href={cls.studentJoinLink?.startsWith('http') ? cls.studentJoinLink : `https://${cls.studentJoinLink}`} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline break-all">
                                Student Link
                              </a>
                            </>
                          )}
